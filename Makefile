...
c:
	...
	gcc -pthread -g -Werror -O1 -o tinyWebServer.ignore.c src/program_1000_1000.ignore.o src/program_1000_500.ignore.o src/program_500_500.ignore.o src/program_100_1000.ignore.o src/program_100_500.ignore.o src/program_50_1000.ignore.o src/program_50_500.ignore.o src/user.ignore.o src/sortNumbers.ignore.o src/extraFunctions.ignore.o src/userParser.ignore.o src/csapp.ignore.o src/webserver.ignore.o -l sqlite3 $(CPP_CFLAGS) $(CPP_LDFLAGS)
